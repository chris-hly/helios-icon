(function (factory) {
	...
	*/
	...
	function y$2() {
	  return (y$2 = Object.assign || function (e) {
	...
	var N$2 = "undefined" != typeof process && (process.env.REACT_APP_SC_ATTR || process.env.SC_ATTR) || "data-styled",
	...
	var j = function () {
	  ...
	  M$2 = "style[" + N$2 + '][data-styled-version="5.3.6"]',
	  ...
	  q$2 = function q(e) {
	    ...
	    r.setAttribute(N$2, "active"), r.setAttribute("data-styled-version", "5.3.6");
	    var i = Y$2();
	  ...
	  X$2 = function () {
	    function e(e, t, n) {
	      void 0 === e && (e = w$2), void 0 === t && (t = {}), this.options = y$2({}, J$2, {}, e), this.gs = t, this.names = new Map(n), this.server = !!e.isServer, !this.server && C$2 && U$2 && (U$2 = !1, function (e) {
	    ...
	    return t.reconstructWithOptions = function (t, n) {
	      return void 0 === n && (n = !0), new e(y$2({}, this.options, {}, t), this.gs, n && this.names || void 0);
	...
	function Ee$1(e) {
	  return ve$1.test(e) ? e.replace(ge$1, we$1).replace(Se$1, "-ms-") : e;
	}
	...
	function _e(e, n, r, o) {
	  ...
	  var l;
	  return e instanceof ye$1 ? r ? (e.inject(r, o), e.getName(o)) : e : g$1(e) ? function e(t, n) {
	    var r,
	      o,
	      s = [];
	...
	function Ae$1(e) {
	  for (var t = arguments.length, n = new Array(t > 1 ? t - 1 : 0), r = 1; r < t; r++) n[r - 1] = arguments[r];
	  return E$2(e) || g$1(e) ? Ne$1(_e(v$3(S$2, [e].concat(n)))) : 0 === n.length && 1 === e.length && "string" == typeof e[0] ? e : Ne$1(_e(v$3(e, n)));
	}
	  ...
	  var C,
	    ...
	    O = function O(e, t) {
	      return function (e, t, n, r) {
	        ...
	        return t.style && g.style !== t.style && (C.style = y$2({}, t.style, {}, g.style)), C.className = Array.prototype.concat(c, h, S !== h ? S : null, t.className, g.className).filter(Boolean).join(" "), C.ref = b, /*#__PURE__*/react.createElement(_, C);
	      }(C, e, t, P);
	    };
	  return O.displayName = v, (C = /*#__PURE__*/react.forwardRef(O)).attrs = N, C.componentStyle = I, C.displayName = v, C.shouldForwardProp = A, C.foldedComponentIds = o ? Array.prototype.concat(e.foldedComponentIds, e.styledComponentId) : S$2, C.styledComponentId = g, C.target = o ? e.target : e, C.withComponent = function (e) {
	    var r = t.componentId,
	      o = function (e, t) {
	        if (null == e) return {};
	        var n,
	...
	var Header$1 = (function () {
	  return /*#__PURE__*/react.createElement(Header, null, /*#__PURE__*/react.createElement("h1", null, "Helios Icons"));
	});
